...
method:
    ...
    q = session.query(SomeMappedClass)plainplainplainplainplain
...
:   ORM 级的 SQL 构造对象。
    ...
    [`Query`](#sqlalchemy.orm.query.Query "sqlalchemy.orm.query.Query")plainplain
...
:   基础：[`sqlalchemy.orm.base.InspectionAttr`](internals.html#sqlalchemy.orm.base.InspectionAttr "sqlalchemy.orm.base.InspectionAttr")
    ...
    为[`AliasedClass`](#sqlalchemy.orm.util.AliasedClass "sqlalchemy.orm.util.AliasedClass")对象提供检查界面。plainplain
...
:   基础：`sqlalchemy.util._collections.AbstractKeyedTuple`
    ...
    `tuple`子类添加标签名称。plainplainplain
...
:   基础：`sqlalchemy.sql.expression.Generative`，`sqlalchemy.orm.interfaces.MapperOption`
    ...
    表示加载器选项，它修改[`Query`](#sqlalchemy.orm.query.Query "sqlalchemy.orm.query.Query")的状态以影响各种映射属性的加载方式。plainplainplain
...
:   在左边和右边的子句之间产生一个左外连接。
    ...
    这是[`orm.join()`](#sqlalchemy.orm.join "sqlalchemy.orm.join")函数的“外部连接”版本，除了生成一个OUTERplainplainplainplain
