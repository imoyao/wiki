...
- [vue-a11y-dialog](https://github.com/morkro/vue-a11y-dialog)-用于可访问对话框[`a11y-dialog`](https://github.com 的 Vue.js 组件包装器。 com / edenspiekermann / a11y-dialog)。
...
- [animated-vue](https://github.com/radical-dreamers/animated-vue)-一个 Vue.js 2.x 插件，可轻松使用 Animate.css 动画作为过渡。就像一样简单！
...
- [vue-headful](https://github.com/troxler/vue-headful)-从视图中设置文档和 meta 标签。
