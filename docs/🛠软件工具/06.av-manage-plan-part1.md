...
规则非常简单，看 tag 英文便能明白需要填入什么，比如：
    ...
    <movie>plainplainplainplainplainplainplainplainplainplainplainplainplainplainplain
      <title>影片标题</title>
      <studio>制作组</studio>
      <year>发行年份</year>
...
我的目录层级如下：
    ...
    硬盘根目录/顶层文件夹plainplainplainplainplainplainplainplain
    ——演员实用度/等级（第一层子文件夹）
    ————演员名字（第二层子文件夹）
    –——————演员所有影片
...
`格式设定`中的`命名格式`修改为：
    ...
    %actor% - [%year%] %title% [%num%]plainplainplainplainplainplainplainplainplainplainplainplainplainplainplain
...
`建立层级目录`修改为：
    ...
    #%actor%plainplainplainplainplainplainplainplainplainplain
...
`更名设定`的第一项建议修改为：
    ...
    NULLplainplainplainplainplainplainplainplainplainplainplainplain
