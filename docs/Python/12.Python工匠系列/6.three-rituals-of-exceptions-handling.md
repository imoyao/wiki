...
- 为什么在写 Python 时鼓励使用异常 *（建议阅读 [“Write Cleaner Python: Use Exceptions”](https://github.com/jeffknupp/blog/blob/master/content/2013-02-06-write-cleaner-python-by-using-exceptions.md)）*
