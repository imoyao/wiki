...
死锁概念处理策略详细介绍：
- [死锁面试题（什么是死锁，产生死锁的原因及必要条件）_hd12370的博客-CSDN博客](https://blog.csdn.net/hd12370/article/details/82814348)
...
![CAP理论](https://cdn.jsdelivr.net//masantu/statics/images/Teorema-CAP.png)
