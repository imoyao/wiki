...
**Flake8** 是由Python官方发布的一款辅助检测Python代码是否规范及提高代码质量的工具，相对于目前热度比较高的Pylint来说，Flake8检查规则灵活，支持集成额外插件，扩展性强。Flake8是对下面三个工具的封装：

*   PyFlakes：（类似 Pylint）静态检查Python代码逻辑错误的工具。
