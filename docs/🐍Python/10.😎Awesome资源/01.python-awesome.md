...
tags: 
  - Python
  - Awesome
permalink: /python/awesome/
categories: 
  - 🐍Python
  - 😎Awesome
---

[awesome-python](https://github.com/vinta/awesome-python) 是 vinta 发起维护的 Python 资源列表，内容包括：Web 框架、网络爬虫、网络内容提取、模板引擎、数据库、数据可视化、图片处理、文本处理、自然语言处理、机器学习、日志、代码分析等。中文版由「开源前哨」和「Python 开发者」微信公号团队维护更新。
...
*   [Jupyter Notebook (IPython)](https://jupyter.org)：一个能够让你最大限度地以交互式方式使用 Python 的丰富工具包。现代 Python 最新的必学工具，让你在浏览器上与 Python 程序交互，功能强大，界面友好，谁用谁知道。
 ...
 * [Bowler](https://pybowler.io/)：适用于现代 Python 的安全代码重构。
...
*   Sublime Text
  ...
  * [SublimeJEDI](https://github.com/srusskih/SublimeJEDI)：一个很棒的自动补全库 Jedi 的 Sublime Text 插件。
*   Vim
